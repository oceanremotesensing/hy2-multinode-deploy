...
# ========= 默认参数 =========
NODE_COUNT=10
REALITY_NODE_COUNT=5
PORT_RANGE_START=20000
PORT_RANGE_END=60000
PASSWORD_PREFIX="PwdHy2_"
HYSTERIA_BIN="/usr/local/bin/hysteria"
WORK_DIR="/etc/hysteria2"
REALITY_DOMAINS=("www.bing.com" "www.apple.com" "www.google.com" "www.cloudflare.com" "www.microsoft.com")
...
if [[ "$CLEAN_MODE" == 1 ]]; then
  info "🧹 开始清理 Hysteria..."
  systemctl disable --now $(systemctl list-units | grep hy2- | awk '{print $1}') || true
